 ...
 * Uses only the standard library except for:
   ...
   * [fclairamb/go-log](https://github.com/oarkflow/ftp-server/log) for logging through your existing libraries [go-kit/log](https://github.com/go-kit/log), [log15](https://github.com/inconshreveable/log15), [zap](https://github.com/uber-go/zap), [zerolog](https://github.com/rs/zerolog/), [logrus](https://github.com/sirupsen/logrus)
