...
func FromContent(content *models.Content, fileName string, logger log.Logger) (*Config, error) {
	c := &Config{
		fileName: fileName,
		logger:   logger,
		Content:  content,
...
func (c *Config) GetAccess(user string, pass string) (*models.Access, error) {
